...
import ar.edu.unlam.pb2.seguro.Auto;
import ar.edu.unlam.pb2.seguro.CompaniaDeSeguro;
import ar.edu.unlam.pb2.seguro.Persona;
import ar.edu.unlam.pb2.seguro.Poliza;
import ar.edu.unlam.pb2.seguro.PolizaAccidentesPersonales;
import ar.edu.unlam.pb2.seguro.PolizaCombinadoFamiliar;
import ar.edu.unlam.pb2.seguro.PolizaDeAuto;
import ar.edu.unlam.pb2.seguro.PolizaInexistente;
import ar.edu.unlam.pb2.seguro.SegurosDeVida;
import ar.edu.unlam.pb2.seguro.SegurosGenerales;
import ar.edu.unlam.pb2.seguro.TipoDeBeneficiario;
import ar.edu.unlam.pb2.seguro.Vivienda;
...
public class testSeguro {
	...
	public void queSePuedaEmitirUnaPolizaDeVida() {
		...
		assertEquals((Integer)2, ((PolizaAccidentesPersonales)poliza).obtenerCantidadDeBeneficiarios());
		assertEquals(asegurado, ((Poliza)poliza).getAsegurado());
		assertEquals(PREMIO, ((Poliza)poliza).getPremio());
	}
	...
	public void queSePuedaDenunciarElRoboDeUnAuto() throws PolizaInexistente {
		...
		assertTrue(((PolizaDeAuto) libra.getPoliza(numeroDePoliza)).fueRobado());
